...
function obtenerIdEtiqueta($nombre_etiqueta,$comercio_id)
{
    ...
    public function GetMargenParaReglaPrecios($product,$columna,$filasTotales,$lista_id,$nombre_lista){
    ...
    public function StoreUpdatePrecioPorcentaje($filasTotales, $product, $comercio_id, $r, $columna, $exists, $costo, $porcentaje_regla_precios, $lista_id, $nombre_lista)
    {
    ...
    public function StoreUpdatePrecios($filasTotales,$i,$product,$comercio_id,$columna,$exists,$nombre_lista,$lista_id){
        ...
        if($regla == 2){
          ...
          $porcentaje_regla_precios = $this->GetMargenParaReglaPrecios($product,$columna,$filasTotales,$lista_id,$nombre_lista);          
    ...
    public function StoreUpdateStock($row,$i,$product,$comercio_id,$id_almacen,$columna,$exists,$nombre_sucursal,$sucursal_id){
        ...
        $valor_almacen = 1;
              ...
              $id_almacen_sucursal = $this->almacenSucursal($valor_almacen, $comercio_id);

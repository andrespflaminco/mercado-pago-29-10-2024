...
class MisOrdenesVerController extends Component
{
    ...
    public function mount($id) {
      ...
      $this->orden = Sale::find($id);
      
      $this->ecommerce = ecommerce::where('comercio_id',$this->orden->comercio_id)->first();
    ...
    public function render()
    {
      ...
      ->where('sales.canal_venta','Ecommerce')
      ->first();
      
      // dd($this->sale_id);
      
      $this->detalle_venta = SaleDetail::where('sale_id',$this->sale_id)->where('eliminado',0)->get();
    ...
    ->get();
      ...
      return view('livewire.mis-ordenes.ver', [
        'orders' => $this->orders,

...
class RegistroYSuscripcionEspecialController extends Component
{
    ...
    public function mount($intencion_compra) {
      $this->intencion_compra = $intencion_compra;
    }
    ...
    $countries = [
      ...
      $planes_suscripcion = planes_suscripcion::find($this->intencion_compra);
       $this->slug = $planes_suscripcion->origen;

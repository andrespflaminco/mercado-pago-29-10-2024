...
class SuscripcionEspecialController extends Component
{
  ...
  public function render()
  {
    ...
    $data =  [
      ...
      'user_amount_value' => config('app.USER_AMOUNT_VALUE'), // Agrega esta l��nea
      'users_amount' => 0,
      'PLAN_MONTO' => $plan ? intval($plan->monto) : 18900 // Agrega esta l��nea
    ];
...
public function AvisoPorMail($email, $user) {
  ...
  public function cancelarSuscripcion(Request $request, $suscripcion_id)
  {
    ...
    return redirect('/suscripcion-configuracion')->with('message', 'Suscripción cancelada correctamente');
  }
...
public function actualizarSuscripcionConfirmed(Request $request, $suscripcion_id, $plan_suscripcion_id, $users_count = null, $modulos_id = null)
  {
    ...
    return redirect('/suscripcion-configuracion')->with('message', 'Suscripción actualizada correctamente');

 ...
 */
 ...
 class CartPedidosSucursales {
    ...
    public function __construct() {
        if (session()->has("cart-pedidos-sucursales")) {
            $this->cart = session("cart-pedidos-sucursales");
        } else {
  ...
  public function getContent()
  {
    ...
    protected function save(): void {
        session()->put("cart-pedidos-sucursales", $this->cart);
        session()->save();
    ...
    public function totalAmount() {
        $precio = $this->cart->sum(function ($product) {
            $precio_total = ($product['cost']*$product['qty']) + ($product['cost']*$product['qty']*$product['iva']);
            return $precio_total;
    ...
    public function totalIva() {
        $precio = $this->cart->sum(function ($product) {
            $precio_total = $product['cost']*$product['qty']*$product['iva'];
            return $precio_total;

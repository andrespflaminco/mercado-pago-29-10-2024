 ...
 */
 ...
 class CartVariaciones {
    ...
    public function __construct() {
        if (session()->has("cart-variaciones")) {
            $this->cart = session("cart-variaciones");
        } else {
  ...
  public function getContent()
  {
    ...
    protected function save(): void {
        session()->put("cart-variaciones", $this->cart);
        session()->save();
    ...
    public function buscarPorReferencia($referenciaVariacion)
    {
        return $this->cart->first(function ($item) use ($referenciaVariacion) {
            return $item['referencia_id'] == $referenciaVariacion;
        });
    }

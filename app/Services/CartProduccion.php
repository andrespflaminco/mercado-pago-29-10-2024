 ...
 */
 ...
 class CartProduccion {
    ...
    public function __construct() {
        if (session()->has("cart_produccion")) {
            $this->cart = session("cart_produccion");
        } else {
  ...
  public function getContent()
  {
    ...
    protected function save(): void {
        session()->put("cart_produccion", $this->cart);
        session()->save();
    ...
    public function totalCantidad() {
        $amount = $this->cart->sum(function ($product) {
            $cantidad_total = floatval($product['qty']);

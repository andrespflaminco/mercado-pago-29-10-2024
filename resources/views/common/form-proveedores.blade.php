<div wire:ignore.self class="modal fade" id="ModalAgregarProveedor" tabindex="-1" role="dialog" style="overflow-y: auto !important;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
								...
								<div class="col-lg-4 col-sm-6 col-12">
									<div class="form-group">
										<label>Telefono</label>
									     <input maxlength="10"  type="text" wire:model.lazy="telefono_proveedor" class="form-control" placeholder="" >
     ...
     <div class="modal-footer">
       ...
       <button type="button" wire:click.prevent="reiniciarUIProveedor()" class="btn btn-cancel" data-dismiss="modal">CERRAR</button>
       <button type="button" wire:click.prevent="StoreProveedor()" class="btn btn-submit" >GUARDAR</button>

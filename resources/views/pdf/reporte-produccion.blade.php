		...
		<table cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td width="70%" class="text-left text-company" style="vertical-align: top; padding-top: 10px">
					@if($reportType == 0)
					<span style="font-size: 16px"><strong>Reporte de Produccion del Día</strong></span>
					@else
					<span style="font-size: 16px"><strong>Reporte de Produccion por Fechas</strong></span>
					@endif
					<br>
					@if($reportType !=0)

					...
					<div class="card">
						<div class="card-body">
							...
							<div {{ Auth::user()->sucursal == 1 ? 'hidden' : '' }} class="col-lg-3 col-sm-6 col-12">
							<h6></h6>
									<div class="form-group">
										<label>Saldo inicial en cuenta corriente Casa central </label>
									   <div class="input-group mb-0">				
                    				    <div class="input-group-prepend">
                                            <span style="height: 100% !important;" class="input-group-text input-gp">
                                                $
                    				   ...
                    				   <input  maxlength="11" type="number" wire:model.lazy="saldo_inicial_cuenta_corriente.{{auth()->user()->casa_central_user_id}}" class="form-control" >
                    				</div>
                    				
                                       @error('saldo_inicial_cuenta_corriente.{{auth()->user()->casa_central_user_id}}') <span class="text-danger er">{{ $message }}</span> @enderror
									</div>
							</div>
							...
							<h6></h6>
									<div class="form-group">
										<label>Saldo inicial en cuenta corriente {{$suc->name}} </label>
									   <div class="input-group mb-0">				
                    				    <div class="input-group-prepend">
                                            <span style="height: 100% !important;" class="input-group-text input-gp">
                                                $
                    				   ...
                    				   <input {{ (auth()->user()->sucursal == 1) && ($suc->sucursal_id != auth()->user()->id) ? 'readonly' : '' }} maxlength="11" type="number" wire:model.lazy="saldo_inicial_cuenta_corriente.{{$suc->sucursal_id}}" class="form-control" >
                    				</div>
                    				
                                       @error('saldo_inicial_cuenta_corriente.{{$suc->sucursal_id}}') <span class="text-danger er">{{ $message }}</span> @enderror
									</div>
							</div>
							@endforeach
							</div>

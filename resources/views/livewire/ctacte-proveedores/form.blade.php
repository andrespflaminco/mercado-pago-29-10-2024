                                ...
                                <tbody>
                                  ...
                                  @foreach($dci as $dci)
                                    <tr>
                                        ...
                                        <td class="text-right"> $ {{number_format($dci->precio,2)}}
                                       </td>
                                        <td class="text-right">{{number_format($dci->cantidad,2)}}


                                        </td>
                                        <td class="text-right">$ {{number_format($dci->precio*$dci->cantidad,2)}}</td>
                                         <td class="text-right">

      ...
      margin: 1.75rem auto;" role="document">
          <div class="modal-content">
              ...
              <div style="margin: 0 auto !important;" class="modal-body">
                ...
                <div class="row">
                 ...
                 <div style="margin-bottom: 0 !important;" class="input-group mb-12">
                   ...
                   <input autocomplete="off" type="date" wire:model.lazy="fecha_ap" class="form-control" required="" value="{{$fecha_editar}}">
                 ...
                 <div style="margin-bottom: 0 !important;" class="input-group mb-12">
                   ...
                   <input autocomplete="off" type="number" id="title" wire:model.lazy="monto_ap" min="0" wire:change='MontoPagoEditarPago($event.target.value)'  class="form-control" required="">
               ...
               <br>
                 <div class="col-sm-12 col-md-12">
                  ...
                  <div class="form-group">
                   ...
                   <select wire:model='metodo_pago_agregar_pago' wire:change='MetodoPagoEditarPago($event.target.value)'  class="form-control">
              ...
              <div class="modal-footer">
                <br>
                <button type="button" wire:click.prevent="CerrarAgregarPago({{$ventaId}})" class="btn btn-dark close-btn text-info" data-dismiss="modal">CERRAR</button>
                @if($formato_modal > 0)

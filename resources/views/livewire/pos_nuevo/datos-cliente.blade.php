      ...
      margin: 1.75rem auto;" class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">CUIT ENCONTRADO</h5>
           ...
           <br><br><br>
              ...
              <div class="modal-footer">
                <br>
                <button type="button" wire:click.prevent="resetCliente()" class="btn btn-cancel" data-dismiss="modal">CERRAR</button>

    	           <button class="btn btn-submit" wire:click="AgregarCliente"  title="Agregar">
                   ACEPTAR
              	</button>
              </div>
          </div>

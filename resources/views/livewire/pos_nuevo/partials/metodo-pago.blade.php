                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                @if($es_pago_dividido == 0)
                                <button style="width:100%; border:solid 1px #c8c8c8;" <button  wire:click="SwitchFormaCobro({{$es_pago_dividido}},1,null)"  class="btn text-center">Pago parcial / pago dividido</button>
                                @else
                                <button style="width:100%; background:grey; color: white; border:solid 1px #c8c8c8;" <button  wire:click="SwitchFormaCobro({{$es_pago_dividido}},1,null)"  class="btn text-center">Pago parcial / pago dividido</button>
                                @endif
                            </div>
						...
						<!---- @include('livewire.pos.pago-dividido') --->
						 ...
						 @include('livewire.pos_nuevo.pago-dividido-dinamico')
						 
						 <!--- 9-1-2024 ---->
						 @include('livewire.pos_nuevo.partials.metodo-pago-sucursal')
						<!------------------>

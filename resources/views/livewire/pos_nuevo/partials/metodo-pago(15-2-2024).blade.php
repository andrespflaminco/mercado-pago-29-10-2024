                        ...
                        <div class="row mt-3">
                            <div class="col-4">
                                ...
                                <button wire:click="CheckPagoParcial(1)"  style="width:100%; border:solid 1px #c8c8c8;" class="btn text-center">Pago total</button>
                                @else
                                @if($pago_parcial == 0)
                                <button wire:click="CheckPagoParcial(1)"  style="background:grey; color: white; width:100%; border:solid 1px #c8c8c8;" class="btn text-center">Pago total</button>
                                @else
                                <button wire:click="CheckPagoParcial(1)"  style="width:100%; border:solid 1px #c8c8c8;" class="btn text-center">Pago total</button>
                                @endif
                                @endif
                            ...
                            <div class="col-4">
                                ...
                                @if($es_pago_dividido == 1)
                                <button wire:click="CheckPagoParcial(0)"  style=" width:100%; border:solid 1px #c8c8c8;" class="btn text-center">Pago parcial</button>
                                @else
                                @if($pago_parcial == 1)
                                <button wire:click="CheckPagoParcial(0)"  style="background:grey; color: white; width:100%; border:solid 1px #c8c8c8;" class="btn text-center">Pago parcial</button>
                                @else
                                <button wire:click="CheckPagoParcial(0)"  style=" width:100%; border:solid 1px #c8c8c8;" class="btn text-center">Pago parcial</button>
                                @endif
                                @endif
                            ...
                            <div class="col-4">
                                ...
                                <button style="width:100%; border:solid 1px #c8c8c8;" wire:click="PagoDividido" class="btn text-center">Pago dividido</button>
                                @else
                                <button style="width:100%; background:grey; color: white; border:solid 1px #c8c8c8;" wire:click="PagoDividido" class="btn text-center">Pago dividido</button>
                                @endif
                            </div>

	...
	@can('abrir caja')
	    ...
	    <a href="javascript:void(0)" class="btn btn-added" style="background: #637381 !important;" wire:click.prevent="AbrirModal({{auth()->user()->id}})" wire:loading.attr="disabled">ABRIR CAJA</a>

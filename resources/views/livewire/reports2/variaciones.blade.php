...
<div wire:ignore.self style="z-index:99999999999999999 !important;" class="modal fade" id="Variaciones" tabindex="-1" role="dialog">
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                <br>
                 ...
                 @if($a->referencia_id ==  $p->referencia_variacion)
                    {{$a->nombre}} -
                 @endif
                 @endforeach
                  </button>

<div>	                
                  ...
                  @include('livewire.reports2.configurar-columnas')
...
<div class="modal fade" id="MailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                 ...
                 <a wire:click.prevent="EnviarMail()" href="javascript:void(0);" class="btn btn-submit me-2" >Enviar</a>
                  ...
                  @include('livewire.reports2.form-imprimir')
                  @include('livewire.reports2.condicion-iva')
                  @include('livewire.reports2.variaciones')
                  @include('livewire.reports2.abrir-caja')
                  @include('livewire.gastos.estado-pedido-pos')
                  @include('livewire.reports2.agregar-pago')
                  @include('livewire.reports2.form-hoja-ruta')
                  @include('livewire.reports2.form-hoja-ruta-nueva')
                  @include('livewire.factura.form-pagos')
                  @include('livewire.reports2.actualizar-estado-venta')
                  @include('livewire.reports2.sales-detail3')
	...
	<div class="card">
            ...
            @endforeach
						...
						<div class="card-body">
							<div class="table-top">
								...
								<div class="wordset">
									<ul>
										...
										<li>
										   <a data-bs-toggle="tooltip" wire:click="ExportarReporte(' {{ ( ($usuarioSeleccionado == '' ? '0' : $usuarioSeleccionado) . '/' . ($ClienteSeleccionado == '' ? '0' : $ClienteSeleccionado)  .  '/' . ($estado_pago == '' ? '0' : ($estado_pago == 'Pago' ? '1' : '2')) . '/'. ($EstadoSeleccionado == '' ? '0' : $EstadoSeleccionado) . '/' . ($MetodoPagoSeleccionado == '' ? '0' : $MetodoPagoSeleccionado) . '/' .  ($estado_facturacion == '' ? 'all' : $estado_facturacion) . '/'  . $dateFrom . '/' . $dateTo) }} ')"
							...
							<div class="card mb-0"  style="border: solid 1px #eee; padding: 20px; display:{{$MostrarOcultar}};">
                                              <div class="card-body">
                                                <div class="row">
							...
							<div class="table-responsive">
								<table class="table">
									<thead>
                                        ...
                                        <th wire:click="OrdenarColumna('created_at')">FECHA
                                        ...
                                        <th wire:click="OrdenarColumna('nombre_cliente')">CLIENTE
                                        ...
                                        <th wire:click="OrdenarColumna('nombre_banco')">FORMA DE PAGO
                                        ...
                                        <th wire:click="OrdenarColumna('deuda')">A COBRAR
                                        ...
                                        <th wire:click="OrdenarColumna('status')">ESTADO
	...
	@else
	@include('livewire.reports2.ver-venta')
	@endif
...
<script>
  ...
  function ConfirmFactura(id) {
    ...
    swal({
      title: 'CONFIRMAR',
      text: '¿QUIERE FACTURAR EN LOTE LAS VENTAS SELECCIONADAS?',
      showCancelButton: true,
      cancelButtonText: 'Cancelar',
      cancelButtonColor: '#fff',
      confirmButtonColor: '#3B3F5C',

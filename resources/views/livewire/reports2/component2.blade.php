    ...
    <div class="col-sm-12">
        <div class="widget">
            <div class="widget-heading">
              ...
              href="{{ url('report/excel' . '/' . ($usuarioSeleccionado == '' ? '0' : $usuarioSeleccionado) . '/' . ($ClienteSeleccionado == '' ? '0' : $ClienteSeleccionado)  .  '/' . ($estado_pago == '' ? '0' : $estado_pago) . '/'. ($EstadoSeleccionado == '' ? '0' : $EstadoSeleccionado) . '/'  . uniqid() .'/'  . $dateFrom . '/' . $dateTo) }}" target="_blank">Exportar a Excel</a>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" >
                                            ...
                                            <a type="button" href="{{ url('report-email/pdf' . '/' . $d->id  . '/' . $d->email) }}" target="_blank"
                                                class="btn btn-dark btn-sm">

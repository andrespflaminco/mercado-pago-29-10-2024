						...
						<tbody>
							...
							@else
									...
									<td>
										<h6 class="text-left">
											<b>
												...
												@if($v->referencia_id == $product->referencia_variacion)
											{{$product->name}}
									...
									<td class="text-center">
										...
										@if($product->cost != 0 )
										<a href="javascript:void(0)" wire:click.prevent="Edit('{{$product->id}}&{{$product->referencia_variacion}}')" class="btn btn-dark" title="Delete">
											<i class="fas fa-eye"></i>
											</a>

											<a href="{{ url('componentes_editar/' . $product->id . '&' . $product->referencia_variacion)}}" class="btn btn-dark mtmobile" title="Edit">
												<i class="fas fa-edit"></i>
											</a>

											<a href="javascript:void(0)" onclick="Confirm('{{$product->id}}&{{$product->referencia_variacion}}')" class="btn btn-dark" title="Delete">
												<i class="fas fa-trash"></i>
												</a>

										@else

										<a href="{{ url('componentes_detalle/' . $product->id . '&' . $product->referencia_variacion)}}" class="btn btn-dark mtmobile" title="Edit">
											<i class="fa fa-plus"></i>
										</a>

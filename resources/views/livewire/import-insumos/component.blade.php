        ...
        <div class="widget widget-chart-one">
            <div class="widget-heading">
                <h4 class="card-title mt-3">
                    <b>Módulo de Importar insumos</b>
                </h4>
                ...
                <div class="row mt-5">
                    <div class="col-sm-8 col-md-6">
                        <div class="form-group custom-file">
                            <label class="custom-file-label">Buscar excel INSUMOS</label>
                            <input type="file" class="custom-file-input form-control" wire:model="fileInsumos" accept=".xlsx, .xls,">

                            @error('fileInsumos') <span class="text-danger er">{{ $message}}</span>@enderror
                    ...
                    @if (count($validacion_errores) > 0)
                        <a href="{{ url('import-insumos') }}" class="btn btn-dark">Cancelar</a>
                    @else
                        <button wire:loading.attr="disabled" wire:click.prevent="ValidateProducts()" {{$fileInsumos =='' ? 'disabled' : ''}} class="btn btn-dark">Importar</button>
                    @endif
                    </div>
            ...
            <a href="javascript:void(0)" wire:click="ExportarInsumos" class="btn btn-success">Exportar Excel de Insumos</a>
            <div class="widget-content">

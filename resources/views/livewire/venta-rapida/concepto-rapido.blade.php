  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="tabsModalLabel">Concepto Rapido</h5>
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Agregar concepto rapido</label>

                  <div class="input-group mb-4">

                  <input autocomplete="off" type="text" id="title" wire:model.lazy="nombre_concepto" class="form-control" required="">
                  <div class="input-group-append">
                            <button type="button" wire:click.prevent="CreateConcepto()" class="btn btn-dark">Agregar</button>

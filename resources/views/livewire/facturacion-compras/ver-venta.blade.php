<div class="page-header">
						<div class="page-title">
							<h4>Factura {{$tipo_factura}}  - {{$NroFactura}} </h4>
							<h6></h6>
						</div>
					</div>
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-4 col-sm-6 col-12">
									<div class="form-group">
										...
										<div class="row">
											...
											<select disabled wire:model="proveedor_id" class="form-control">
                                ...
                                @can("anular factura")
                                <button hidden type="button" class="btn btn-warning" style="  min-width: 130px; margin-bottom: 0 !important;  margin-right: 15px; margin-bottom: 0 !important;  padding: 0.375rem 0.75rem !important;" onclick="ConfirmAnularFactura('{{$factura_id}}')">
                                ANULAR FACTURA
                                </button>
                                @endcan
                                ...
                                @endif
					           	...
					           	<a hidden class="btn" style="box-shadow: none; border: solid 1px #515365; background:transparent; margin-left: 10px !important;" href="javascript:void(0)" wire:click="MailModalVerVenta({{$factura_id}})" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                                Enviar
                                </a>
                    
                                <button hidden style="color: #212529; box-shadow: none; border: solid 1px #515365; background:transparent; margin-left: 10px !important;" class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
									...
									<table class="table">
										...
										<tbody>
										   <?php $i = 1; ?>
                                            ...
                                            <td> {{number_format($item->alicuota_iva,2)}} %</td>
                                            <td> 
                                            $ {{number_format(( $item->precio *(1 + $item->alicuota_iva)) ,0)}}
                                            </td>
                                            <td class="text-center">
                                            <div class="input-group mb-0">
                                            <input disabled style="max-width: 80px;" type="text" class="boton-editar"  value="{{ number_format(($item->descuento)/$item->precio*100/$item->cantidad,2) }}" > 
                                            ...
                                            $ {{number_format( (( ($item->precio*$item->cantidad) - $item->descuento ) *(1 + $item->alicuota_iva)) ,0)}}

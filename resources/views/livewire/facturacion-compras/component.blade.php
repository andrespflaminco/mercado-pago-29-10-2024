...
<div class="col-12 text-center">
    ...
    <br>
    <br>
    <a class="btn btn-submit" href="{{ url('regist') }}">SUSCRIBIRSE</a>
</div> 
</div> 
</div> 
...
<div class="modal fade" id="MailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="page-header">
					<div class="page-title">
							...
							<h6>Ver las facturas recibidas</h6>
						</div>
						<div class="page-btn">
							...
							<div class="table-top">
								...
								<div class="wordset">
									<ul>
										...
										<li>
										   <a data-bs-toggle="tooltip" wire:click="ExportarReporteCompras(' {{ ( ($tipo_comprobante_buscar == '' ? '0' : $tipo_comprobante_buscar) .  '/' . ($ProveedorSeleccionado == '' ? '0' : $ProveedorSeleccionado)  . '/'  . $dateFrom . '/' . $dateTo) }} ')"
											data-bs-placement="top" title="Exportar excel"><img  src="{{ asset('assets/pos/img/icons/excel.svg') }}"  alt="img">
                                                  ...
                                                  <div class="col-sm-12 col-md-4">
                                                   <div class="form-group">
                                                    ...
                                                    <div wire:ignore>
                                                        ...
                                                        <select class="form-control tagging" multiple="multiple" id="proveedores-dropdown">
                                                   ...
                                                   <div class="form-group">
                                                    <label>Tipo de comprobante</label>
                                                        ...
                                                        <select wire:model="tipo_comprobante_buscar" class="form-control" >
                                                          ...
                                                          <option value="{{$tc}}">Factura {{$tc}} </option>
                                                          @endforeach
                                                      </select>
                                                  </div>
                                                  </div>
						...
						<div class="col-lg-4 col-sm-6 col-12">
							<div class="dash-widget">
								...
								<div class="dash-widgetcontent">
									...
									<h6>Total facturas recibidas</h6>
								</div>
							</div>
						</div>
                         ...
                         @endif
       						...
       						<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
                                        <th wire:click="OrdenarColumna('nro_venta')">NRO COMPRA
                                        ...
                                        <th wire:click="OrdenarColumna('tipo')" >TIPO
                                        ...
                                        <th wire:click="OrdenarColumna('nro_factura')" >NUMERO DE COMPROBANTE
                                        ...
                                        <th hidden wire:click="OrdenarColumna('nota_credito')" > NOTA CREDITO
                                        ...
                                        <th wire:click="OrdenarColumna('nombre')">NOMBRE
                                        ...
                                        <th wire:click="OrdenarColumna('cuit')">CUIT
                                            @if ($columnaOrden == 'cuit')
                                                @include('livewire.reports.flecha-' . ($direccionOrden === 'asc' ? 'arriba' : 'abajo'))
                                            @else 
                                                @include('livewire.reports.flecha-arriba-abajo')
                                            @endif
                                    ...
                                    <tr><td colspan="12"><h5>Sin Resultados</h5></td></tr>
                                    @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <div class="btn-group mb-1 mr-1">
                                                    ...
                                                    @if($d->nota_credito == null)
                                                    @can("anular factura")
                                                    <a hidden href="javascript:void(0);" onclick="ConfirmAnularFactura({{$d->factura_id}})" class="dropdown-item"><i class="flaticon-dots mr-1"></i>  Anular factura (Nota de credito) </a>
                                                    @endcan
                                                    @endif                                                
	...
	@else
	@include('livewire.facturacion-compras.ver-venta')
	@endif
...
<script>
    ...
    document.addEventListener('livewire:load', function () {
        ...
        $('#proveedores-dropdown').on('change', function(e) {
          @this.emit('ProveedorSelected', $('#proveedores-dropdown').select2('val'));
        });
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        $('.tagging').select2({
                ...
                $('#select2-dropdown').on('change', function(e) {
                  ...
                  @this.set('ProveedorSelectedName', name);
                  @this.set('ProveedorSeleccionado', id);
                  @this.emit('ProveedorSelected', $('#select2-dropdown').select2('val'));
                });

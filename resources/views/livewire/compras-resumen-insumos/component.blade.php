	               ...
	               @if($accion == 0)
                        <div class="page-header mt-2" style="width: 100% !important;">
							<div class="page-title">
								<h4>COMPRAS INSUMOS</h4>
								<h6>Listado de compras de insumos</h6>
							</div>
							<div class="page-btn">
							   	<a href="{{ url('compras-insumos') }}" class="btn btn-added">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th hidden @if(!$columns['etiquetas']) style="display: none;" @endif>Etiquetas</th>
										...
										<tbody>
											...
											<tr>
												...
												<td hidden @if(!$columns['etiquetas']) style="display: none;" @endif>
                    ...
                    @if($accion == 1)
						@include('livewire.compras-resumen-insumos.agregar-editar-compra')
					@endif
	                
	                @if($accion == 2)
					@include('livewire.compras-resumen-insumos.actualizar-compra')
					@endif
					
					@if($accion == 3)
					@include('livewire.compras-resumen-insumos.elegir-recalcular-deuda')
					@endif

          ...
          <div style="float:right;">
            ...
            @if($t->sale_casa_central == null)
              ...
              @else 
                            ...
                            <!----- Si es una compra a la casa central ---->
              
              @foreach($total as $t)
              
                    @if($t->status == 1)
                    <button style="   min-width: 130px; margin-bottom: 0 !important;  margin-top: -2px !important;  margin-right: 15px;  padding: 3px !important;" 
              ...
              <a target="_blank" href="{{ url('imprimir-compra/pdf' . '/' . $ventaId ) }}" class="btn btn-light" style="color: #515365 !important; margin-left: 10px !important;" type="button">

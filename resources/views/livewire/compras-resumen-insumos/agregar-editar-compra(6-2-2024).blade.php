...
<div class="card">
						<div class="card-body">
							<div class="row">
								...
								<select class="select2" id="{{$NroVenta}}" multiple="multiple" data-relacion-id="{{ $NroVenta }}"> 
								...
								<button class="btn btn-light" wire:click="VerElegirTipoActualizacion()">Editar Deuda</button>
								</div>
								</div>
									...
									<table class="table">
										...
										<tbody>
										    ...
										    <tr>
												...
												<td class="text-end">{{number_format(($dc->precio*$dc->cantidad)*(1+$dc->alicuota_iva)*(1+$dc->actualizacion),2)}}</td>
												<td >
												    @if($dci->count() == 1)

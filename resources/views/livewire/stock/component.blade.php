		...
		<div class="widget widget-chart-one">
			...
			<div class="widget-heading">
				...
				<ul class="tabs tab-pills {{ $sucursal_id != $comercio_id ? 'hide-sucursales' : '' }}">
					...
					<li>
						  @if($wc_yes != 0)
						<a href="javascript:void(0)" class="tabmenu bg-dark mr-3" wire:click="wc_sincronizar()">
					...
					<div style="padding-left: 0;" class="col-3 ml-0">
						<div  class="input-group mt-2 mb-1">
							<select style="padding: 6px; border-color: #bfc9d4;" type="text" wire:model="accion_lote" placeholder="Acciones en lote">
								...
								<option value="2">Mover a otra sucursal</option>
					...
					<table  id="default-ordering" class="table table-hover">
	                  ...
	                  @endif
							...
							<th wire:click="sort('stock')" style="background: #3B3F5C;     min-width: 80px; vertical-align: middle !important; padding:5px !important;" class="table-th text-white text-center">
								...
								<th wire:click="sort('seccionalmacen_id')" style="background: #3B3F5C; vertical-align: middle !important; font-size: 12px;" class="table-th text-white text-center">ALMACEN</th>
							...
							<tr>
	      					...
	      					<span class="new-control-indicator"></span><span class="new-chk-content">.</span>
								...
								<td class="text-center">
									...
									@endcan
									@can('product_destroy')
									<a href="javascript:void(0)" onclick="Confirm('{{$product->id}}')" class="btn btn-dark {{ $sucursal_id != $comercio_id ? 'hide-sucursales' : '' }}" title="Delete">

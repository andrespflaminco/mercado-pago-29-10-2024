	...
	<div class="col-sm-12">
		<div class="widget widget-chart-one">
			<ul class="nav nav-tabs  mb-3">
				...
				<li class="nav-item">
						<a class="nav-link active" href="{{url('products-stock')}}" > STOCK </a>
				</li>
				...
				<ul class="tabs tab-pills {{ $sucursal_id != $comercio_id ? 'hide-sucursales' : '' }}">
					...
					<li>
						...
						@endif
							...
							<a hidden href="javascript:void(0)" data-toggle="modal" data-target="#ExportarStock" class="tabmenu bg-dark mr-3">Exportar Stocks</a>
							<a hidden href="{{url('import-stock')}}" class="tabmenu bg-dark mr-3">Importar Stocks</a>
							@if(1 < Auth::user()->plan)
				...
				<div class="table-responsive" style="overflow-x: auto !important;">
					<table  id="default-ordering" class="table table-hover">
	                  ...
	                  @endif
								...
								<th style="background: #3B3F5C;  vertical-align: middle !important; padding:5px 0px 5px 0px !important;" class="table-th text-white text-center">
									STOCK MINIMO
								</th>
						...
						<tbody>
							...
							<tr>
							 ...
							 <input type="checkbox" wire:model.defer="id_check" tu-attr-id="{{($product->id)}}"  class="mis-checkboxes" value="{{$product->id}}">
								...
								<td>
									<h6 class="text-center">{{$product->alerts}} unid.</h6>
								</td>
								...
								<td class="text-center">
									...
									<text style="color:red;">C: {{$pl->stock}} unid.  </text> <br>
									<text style="color:red;">R: {{$pl->stock_real}} unid.  </text> 
									@else
									<text>C: {{$pl->stock}} unid.  </text>
									<text>R {{$pl->stock_real}} unid.  </text>
									@endif 

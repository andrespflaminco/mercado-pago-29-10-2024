					...
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-lg-4 col-sm-6 col-12">
									<div class="form-group">
										...
										<div class="row">
											...
											<select {{ $canal_venta == "Venta a sucursales" ? 'disabled' : '' }} wire:model="cliente_id" id="c" wire:change="selectCliente( $('#c').val() )" class="form-control">
											...
											<div class="col-lg-1"><button {{ $canal_venta == "Venta a sucursales" ? 'disabled' : '' }}  class="btn btn-dark" wire:click="ModalAgregarCliente">+</button></div>
										</div>
									</div>
								</div>
                                ...
                                @if($wc != null)
                                <a class="btn" wire:click="SincronizarVentaWC({{$id_pedido}},1)" style="box-shadow: none; border: solid 1px #515365; background:transparent; margin-left: 10px !important;" href="javascript:void(0)" >
								...
								<div class="col-lg-12 col-sm-6 col-12">
									<div class="form-group">
										...
										@else
										<div class="input-groupicon">
											<input style="font-size:14px !important;" type="text" class="form-control" wire:model="query_product" wire:keydown.escape="resetProduct" wire:keydown.tab="resetProduct" type="text" placeholder="Scanear/Buscar producto...">
											<div class="addonset">
												<img src="{{ asset('assets/pos/img/icons/scanners.svg') }}" alt="img">
											</div>
										</div>
									...
									<table class="table">
										...
										<tbody>
										   <?php $i = 1; ?>
                                            ...
                                            @if ($item->stock_descubierto === "si")
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="boton-editar form-control" 
                                           ...
                                           <td>
                                            ...
                                            <a style="vertical-align: middle;  font-size: 18px;  font-weight: 700;  margin-right: 7px;" title="Agregar descuento" wire:click="ModalAgregarPromo({{$item->id}})">
                                            - % 
                                            </a>
											...
											<div class="dropdown-menu">
												...
												<a class="dropdown-item" href="javascript:void(0);" onclick="ConfirmCambiarEstado({{$item->id}},1)">Entregado</a> <!--- estado a elegir --->
												@endif
												@endif
												@if($item->estado == 1)
												<a class="dropdown-item" href="javascript:void(0);" onclick="ConfirmCambiarEstado({{$item->id}},2)">Pendiente</a> <!--- estado a elegir --->
									...
									<div class="total-order">
										...
										<ul>
											...
											<li>
												...
												Descuento general (
												@if(0 < $t->descuento)
												{{number_format( ($t->descuento * (1 +  $alicuota_iva) ) /$t->total * 100 ,2)}} 
												@else
												0
												@endif
												%)
                                                     ...
                                                     <table class="multi-table table table-hover" style="width:100%">
                                                         <thead>
                                                             <tr>
                                                                 ...
                                                                 <th class="text-center">Comisiones metodo pago</th>
                                                               ...
                                                               <td class="text-center">Caja # {{$p2->nro_caja}}</td>
                                                                ...
                                                                <td class="text-center">$
                                                                 ...
                                                                 @if($relacion_precio_iva == 1)   
                                                                  ...
                                                                  @endif
                                                                   <td class="text-center">$
                                                                        {{number_format($p2->monto + $p2->recargo + $p2->iva_pago + $p2->iva_recargo,2) }}
                                                                    </td>
                                                                    <td class="text-center">$
                                                                    {{number_format($p2->deducciones,2) }}
                                                                    </td>
                                                                   <td>
                                                                       {{number_format($p2->monto + $p2->recargo + $p2->iva_pago + $p2->iva_recargo - $p2->deducciones,2) }} 
                                                                   </td>

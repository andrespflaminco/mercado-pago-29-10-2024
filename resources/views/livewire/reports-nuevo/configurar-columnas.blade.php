...
<div style="margin-bottom: 0 !important; margin-top: -25px !important; margin-left: -25px !important; margin-right: -25px !important;" class="card" id="miDiv">
    ...
    <label><input style="margin-left:15px; margin-right:5px;" type="checkbox" wire:click="toggleColumnVisibility('descuento_promo')" wire:model="columns.descuento_promo" /> DESCUENTO PROMOCIONES</label>
    ...
    <label><input style="margin-left:15px; margin-right:5px;" type="checkbox" wire:click="toggleColumnVisibility('dias_desde_creacion')" wire:model="columns.dias_desde_creacion" /> DIAS DE DEUDA</label>  

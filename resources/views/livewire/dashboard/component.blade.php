...
@include('livewire.dashboard.filtros')
</div>
<div style="margin-top:50px !important;">

@include('livewire.dashboard.filtros-tipo-grafico')    
@if($ver == "ventas")
@include('livewire.dashboard.dash-ventas')     
@endif

@if($ver == "ingresos-gastos")
@include('livewire.dashboard.dash-ingresos-egresos')     
@endif

@if($ver == "stock")
@include('livewire.dashboard.dash-stock')     
@endif
...
@include('livewire.dashboard.script-ventas')

@include('livewire.dashboard.script-ingresos-egresos')

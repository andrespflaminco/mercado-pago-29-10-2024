<div wire:ignore.self class="modal fade" id="theModal-cliente" tabindex="-1" role="dialog">
  <div style="min-width: 850px !important; " class="modal-dialog modal-lg" role="document">
...
<div class="col-sm-12 col-md-6">
	<div class="form-group">
		<label >DNI</label>
		<input type="text" wire:model.lazy="dni"
		class="form-control" placeholder="ej: 36891098"  >

      ...
      margin: 1.75rem auto;" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <b>{{ $formato_modal > 0 ? 'EDITAR PAGO' : 'NUEVO PAGO' }} || COMPRA {{$compra_id}}</b>
              ...
              <div class="modal-footer">
                ...
                <a href="javascript:void(0);" wire:click.prevent="CerrarAgregarPago({{$compra_id}})" class="btn btn-cancel" data-dismiss="modal">Cerrar</a>
                @if($formato_modal > 0)

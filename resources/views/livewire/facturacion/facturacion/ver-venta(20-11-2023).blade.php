						...
						<div class="card-body">
									...
									<table class="table">
										...
										<tbody>
                                           ...
                                           <td>
                                            ...
                                            <input  style="max-width: 80px;" type="text" class="boton-editar"  value="{{ number_format(($item->descuento)/$item->price*100/$item->quantity,2) }}" 
                                            id="d{{$item->id}}"
                                            ...
                                            <input  style="max-width: 80px;" type="text" class="boton-editar"  value="{{ number_format(0,2) }}"  id="d{{$item->id}}"
                                            wire:change="UpdateDescuentoRecargo({{$item->id}}, $('#d' + {{$item->id}}).val() )"
                                           <div class="input-group-append">
                                             <span class="input-group-text input-gp">
                                             %
							...
							<div  class="row">
							    <div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Tipo de factura</label>
											<select wire:model="tipo_factura" id="tipo_factura" wire:change="UpdateIvaGral( $('#tipo_factura').val() )"  class="form-control">
							    ...
							    <div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>IVA</label>
											<select wire:model="alicuota_iva" id="iva" wire:change="UpdateIvaGral( $('#iva').val() )"  class="form-control">

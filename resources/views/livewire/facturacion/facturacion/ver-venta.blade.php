						...
						<div class="card-body">
									...
									<table class="table">
										...
										<tbody>
                                           ...
                                           <td>
                                            ...
                                            <input style="max-width: 100px;" type="text" class="boton-editar"  value="{{$item->precio_original}}" id="price{{$item->id}}"
                                           ...
                                           <div class="input-group-append">
                                            ...
                                            $ {{number_format( (( ($item->price*$item->quantity) - $item->descuento ) *(1)) ,2)}}
                                            ...
                                            <div class="d-flex">
                                            @if($i == 2)
                                            <a onclick="MsgError('La venta contiene un solo producto, no podes eliminarlo.','Tenes que eliminar la venta')" ><img src="{{ asset('assets/pos/img/icons/delete.svg') }}" alt="svg"></a>
											@else
							...
							<div  class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Estado</label>
										<select wire:model="status" id="status" {{$status == 'Entrega Parcial' ? 'disabled' : '' }} wire:change="Update( $('#status').val() , 1 )" class="form-control">

...
MercadoPago\SDK::setAccessToken($tk);
  ...
  $preference = new MercadoPago\Preference();
   ...
   $item->title = 'Plan flaminco';
   $item->quantity = 1;
   $item->currency_id = "ARS";
   $item->unit_price = 1990;

   $products[] = $item;


$preference->back_urls = array(
"success" => route('planes.pay'),
"failure" => route('planes.pay'),
"pending" => route('planes.pay')
...
MercadoPago\SDK::setAccessToken($tk);
  ...
  $preference2 = new MercadoPago\Preference();
   ...
   $item2->title = 'Plan flaminco';
   $item2->quantity = 1;
   $item2->currency_id = "ARS";
   $item2->unit_price = 2500;
...
$preference2->items = $products2;
$preference2->save();

}

if($preference2 != null) {
    $preferencia2 = $preference2->id;
} else {
$preferencia2 = "";
  ...
  <div class="componente">
  	                                    ...
  	                                    <div class="pricing-plans-container mt-lg-5 mt-sm-2 d-md-flex d-block">
  	                                        ...
  	                                        <div class="pricing-plan mb-lg-5 mb-sm-3 mt-sm-3">
  	                                            ...
  	                                            <a href="javascript:void(0);" wire:click="Plan('1')" class="button btn btn-default btn-block margin-top-20">Suscribirse</a>
  	                                        </div>
                          ...
                          <div id="boton_mp" class="cho-container"></div>


                            <br><br>
                          <div id="boton_mp2" class="cho-container"></div>
...
<script>
			...
			const checkout = mp.checkout({
			   ...
			   render: {
			       container: '#boton_mp', // Clase CSS para renderizar el botón de pago
			       label: 'FINALIZAR COMPRA', // Cambiar el texto del botón de pago (opcional)
			    }
			});

  			//Adicione as credenciais de sua conta Mercado Pago junto ao SDK
  			const mp2 = new MercadoPago('<?php echo $ky; ?>', {
  			    locale: 'es-AR'
  			});
  			const checkout2 = mp2.checkout2({
  			   preference: {
  			       id: '{{ $preferencia2 }}' // Indica el ID de la preferencia
  			   },
  			   render: {
  			       container: '#boton_mp2', // Clase CSS para renderizar el botón de pago
  			       label: 'FINALIZAR COMPRA2 ', // Cambiar el texto del botón de pago (opcional)
  			    }
  			});

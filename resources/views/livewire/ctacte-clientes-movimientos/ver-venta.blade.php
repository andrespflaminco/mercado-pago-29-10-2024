						...
						<div class="card-body">
									...
									<table class="table">
										...
										<tbody>
										   <?php $i = 1; ?>
                                            ...
                                            <td>
                                            @if($status == "Cancelado")
                                            <input readonly style="max-width: 70px;" type="text" readonly class="boton-editar"  value="{{number_format($item->quantity,0)}}"  >
                                             @else
                                            @if ($item->stock_descubierto === "si")
                                            <input readonly style="max-width: 70px;"  type="number" class="boton-editar"  value="{{number_format($item->quantity,0)}}" id="qty{{$item->id}}"
                                            wire:keyup.enter="updateQtyPedido({{$item->id}}, $('#qty' + {{$item->id}}  ).val() )" wire:change="updateQtyPedido({{$item->id}}, $('#qty' + {{$item->id}}  ).val() )" min="1" onchange="Update({{$item->id}});" >
                                           ...
                                           <td>
                                            ...
                                            @else
                                            @if($status == "Cancelado")
                                            <input readonly style="max-width: 70px;" type="text" readonly class="boton-editar"  value="{{number_format($item->price,2)}}"  >
                                            @else
							...
							<div  class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Estado</label>
										<select disabled wire:model="status" id="status_ver" {{$status == 'Entrega Parcial' ? 'disabled' : '' }} wire:change="UpdateEstadoVerVenta( $('#status_ver').val() , 1 )" class="form-control">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Relacion PRECIO - IVA</label>
											<select disabled {{$status == "Cancelado"? 'readonly' : '' }}   wire:model="relacion_precio_iva" id="relacion_precio_iva" wire:change="SwitchUpdateRelacionPrecioIva( $('#relacion_precio_iva').val() , {{$NroVenta}} , 1 )"  class="form-control">
							    ...
							    <div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>IVA (%)</label>
										<input readonly disabled type="text" value="{{number_format($alicuota_iva*100,1)}}">
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<textarea  readonly wire:model="nota_interna" id="nota_interna" wire:keydown.enter="UpdateNotaInterna( $('#nota_interna').val() )" wire:change="UpdateNotaInterna( $('#nota_interna').val() )"  class="form-control"></textarea>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
										<label>Observaciones</label>
										<textarea readonly wire:model="observaciones" id="observaciones" wire:keydown.enter="UpdateObservaciones( $('#observaciones').val() )" wire:change="UpdateObservaciones( $('#observaciones').val() )"  class="form-control"></textarea>
									</div>
								</div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-12">
    									<div class="form-group">
    									    ...
    									    <input readonly type="text" id="nombre_destinatario" wire:change="UpdateNombreDestinatario( $('#nombre_destinatario').val() )" wire:model="nombre_destinatario">
    									</div>
    								</div>
    								<div class="col-lg-3 col-sm-6 col-12">
    									<div class="form-group">
    										<label>Direccion</label>
    									    <input  readonly type="text"  wire:model="direccion" id="direccion" wire:change="UpdateDireccion( $('#direccion').val() )">
    									</div>
    								</div>
    								<div class="col-lg-3 col-sm-6 col-12">
    									<div class="form-group">

           ...
           <div style="width:85%;" class="modal-body">
             <br><br>
                       ...
                       <table id="tablaReq" class="multi-table table table-hover" style="width:100%">
                           ...
                           <tbody>
                               ...
                               <tr>
                                   ...
                                   <td class="text-center">$ {{ number_format($p1->cash,2) }} <input hidden type="number" class="monto" value="{{$p1->cash}}"></td>
                               ...
                               <tr id="material{{$p2->id}}">
                                ...
                                <input type="text" class="monto" name="monto[]" id="cambio{{$p2->id}}" onchange="Cambio({{$p2->id}})"value="{{ number_format($p2->monto,2) }}"> </td>
                                <td class="text-center">
               ...
               @if(($suma_monto+$suma_cash) < $tot)
                 ...
                 <strong>Deuda: $ {{number_format($tot - ($suma_monto+$suma_cash),2) }}</strong>
               </div>
...
var cont = $(".material").length;
    ...
    var html = "<tr id = 'material"+(cont+1)+"' class = 'material'>"+"<td class='text-center'> <input hidden type='text' name='fecha[]'  value='{{\Carbon\Carbon::parse(now())}}' > {{\Carbon\Carbon::parse(now())->format('d-m-Y')}} </td>"+"<td class='text-center'>$ <input type='number' class='monto' name='monto[]'  value='"+monto+"' ></td>"+"</tr>";

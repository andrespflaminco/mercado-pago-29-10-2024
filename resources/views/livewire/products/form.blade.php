      ...
      @foreach ($cart->getContent() as $key => $variaciones)
       ...
       <div style="border: solid 1px #bfc9d4;  border: solid 1px #bfc9d4;  border-radius: 6px;">
         ...
         <div class="row" style="padding: 30px;"  id="{{$variaciones['referencia_id']}}">
                    ...
                    <!------ ACA ESTAN LOS PRECIOS INTERNOS -------->
                       ...
                       <div class="form-group">
                          ...
                          <div style="border: solid 1px #bfc9d4;  border: solid 1px #bfc9d4;  border-radius: 6px;   padding: 12px ;">
                            ...
                            <div class="row col-12">
                               ...
                               <div class="form-group col-sm-12 col-md-4">
                                 <label>Precio interno</label>
                                  <input type="number" wire:model.lazy="precios_internos_variacion.{{$variaciones['referencia_id']}}"  class="form-control" placeholder="ej: 0.00" >
           ...
           <div class="col-sm-12 col-md-12">
            <div class="form-group">
                <label>Listas de precios al consumidor </label>
                <br>
               <div style="border: solid 1px #bfc9d4;  border: solid 1px #bfc9d4;  border-radius: 6px;   padding: 12px ;">
               ...
               <div style="border: solid 1px #bfc9d4;  border: solid 1px #bfc9d4;  border-radius: 6px;   padding: 12px ;">
                 ...
                 <div class="row col-12">
					...
					<table  id="default-ordering" class="table table-hover">
					  <thead class="text-white" style="color: white !important;  background: #3B3F5C; vertical-align: middle !important;">
						<tr>
						   <th class="text-left text-white">Sucursal</th>
						   <th class="text-center text-white">Stock real</th>
						   <th class="text-center text-white">Stock disponible</th>
						   <th class="text-center text-white">Stock comprometido</th>
                        </tr>    
                      </thead>
                        <tbody>
                        @if(auth()->user()->sucursal != 1)    
                        <tr>
                            <td class="text-center text-white"> {{auth()->user()->name}}</td>
   ...
   <div class="form-group">
      ...
      <div style="border: solid 1px #bfc9d4;  border: solid 1px #bfc9d4;  border-radius: 6px;   padding: 12px ;">
        ...
        <div class="row col-12">
           ...
           <div class="form-group col-sm-12 col-md-4">
            <br>
            <input type="number" wire:model.lazy="precio_interno" class="form-control" placeholder="ej: 0.00" >
          </div>
        ...
        <div class="row col-12">
             ...
             <div class="table-responsive" style="overflow-x: auto !important;">
					<table  id="default-ordering" class="table table-hover">
					  <thead class="text-white" style="color: white !important; background: #3B3F5C; vertical-align: middle !important;">
						<tr>
						   <th class="text-center text-white">Sucursal</th>
						   <th class="text-center text-white">Stock real</th>
						   <th class="text-center text-white">Stock comprometido</th>
						    <th class="text-center text-white">Stock disponible</th>
                        </tr>    
                        ...
                        <tr>
                            ...
                            <td class="text-center"> 
                                <input type="number" required wire:model.lazy="stock_sucursal.0|0|0|0" class="form-control text-center" placeholder="ej: 0.00" >
                                 @error('stock_sucursal') <span class="text-danger er">{{ $message }}</span> @enderror
                            </td>
                        ...
                        <tr>
                            <td> {{$sucu->name}} </td>
                            <td> 
                               <input type="number" required class="form-control  text-center" wire:model="stock_sucursal.0|{{ $sucu->sucursal_id }}|0|0" />
                                @error('stock_sucursal') <span class="text-danger er">{{ $message }}</span> @enderror
                             </td>
                            <td> </td>
                            <td></td>

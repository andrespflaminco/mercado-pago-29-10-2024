							...
							<div class="row">
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										...
										<select wire:model.defer='proveedor' {{ $es_sucursal == 1? 'disabled' : '' }} {{ $forma_edit == 1? 'disabled' : '' }} {{$tipo_producto == 2 ? 'disabled' : '' }}  wire:change.defer='ModalProveedor($event.target.value)'  class="form-control">
    									    <option value="Elegir" disabled >Elegir</option>
								...
								<div class="col-lg-3 col-sm-6 col-12">
									<div class="form-group">
										<label>Almacen</label>
										<select wire:model.defer='almacen' {{ $es_sucursal == 1? 'disabled' : '' }} {{ $forma_edit == 1? 'disabled' : '' }} wire:change.defer='ModalAlmacen($event.target.value)' class="form-control">
    									    <option value="Elegir" disabled >Elegir</option>

<div >	                
						...
						<div class="card-body">
							<div class="table-top">
								...
								<div  class="wordset">
									<ul>
									    @if(Auth::user()->sucursal != 1)
									    @can('configurar visibilidad lista precios')
									    <li>
									...
									<tbody>
										...
										<tr>
											...
											<td>
											    @if(Auth::user()->sucursal != 1)
											    @if(Auth::user()->profile != "Cajero" )
											  	<a class="me-3" href="javascript:void(0)" wire:click.prevent="EditListasDefecto(0)" >
					...
					@include('livewire.lista-precios.lista-precio-muestra-sucursales')

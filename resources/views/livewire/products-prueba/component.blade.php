	...
	<div class="col-sm-12">
		<div class="widget widget-chart-one">
			<ul class="nav nav-tabs  mb-3">
				<li class="nav-item">
						<a class="nav-link"  href="{{url('products-precios')}}"  > CATALOGO  </a>
				</li>
				<li class="nav-item">
			...
			<div class="widget-heading">
				...
				<ul class="tabs tab-pills {{ $sucursal_id != $comercio_id ? 'hide-sucursales' : '' }}">
					...
					<li>
						...
						<a href="javascript:void(0)" wire:click="ModalAgregar()"class="tabmenu bg-dark {{ Auth::user()->sucursal == 1 ? 'hide-sucursales' : '' }}">Agregar Producto</a>

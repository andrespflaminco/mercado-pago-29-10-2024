	...
	<div class="col-sm-12">
		<div class="widget widget-chart-one">
			<ul class="nav nav-tabs  mb-3">
				<li class="nav-item">
						<a class="nav-link  {{ $vista_id == 3 ? 'active' : '' }} " href="javascript:void(0)"  wire:click="ElegirVista('3')"  > CATALOGO  </a>
				</li>
				<li class="nav-item">
						<a class="nav-link  {{ $vista_id == 1 ? 'active' : '' }} " href="javascript:void(0)"  wire:click="ElegirVista('1')"  > PRECIOS </a>
				</li>
				<li class="nav-item">
						<a class="nav-link  {{ $vista_id == 2 ? 'active' : '' }} " href="javascript:void(0)"  wire:click="ElegirVista('2')"  > STOCK </a>
				</li>
			...
			<div class="widget-heading">
				...
				<ul class="tabs tab-pills {{ $sucursal_id != $comercio_id ? 'hide-sucursales' : '' }}">
					...
					<li>
						...
						<a href="{{url('import-precios')}}" class="tabmenu bg-dark mr-3">Importar Precios</a>
						@endif
						@if($vista_id == 2)
							<a href="javascript:void(0)" data-toggle="modal" data-target="#ExportarStock" class="tabmenu bg-dark mr-3">Exportar Stocks</a>
							<a href="{{url('import-stock')}}" class="tabmenu bg-dark mr-3">Importar Stocks</a>
							<a href="{{url('movimiento-stock')}}" class="tabmenu bg-dark mr-3">Mover Stock</a>
						@endif
						@if($vista_id == 3)

						 <button wire:click="ExportarCatalogo()" style="font-size: 14px; letter-spacing: 1px; font-weight: 600;  color: #fff; border-radius: 4px;" class="tabmenu bg-dark mr-3">Exportar Catalogo</button>
						<a href="{{url('import')}}" class="tabmenu bg-dark mr-3">Importar Catalogo</a>
						@endif




						<a href="javascript:void(0)" class="tabmenu bg-dark" wire:click="ModalAgregar()">Agregar Producto</a>
				...
				<!---------- ACCIONES EN LOTE -------->
					<div style="padding-left: 0;" class="col-3 ml-0">
						<div  class="input-group mt-2 mb-1">
							<select style="padding: 6px; border-color: #bfc9d4;" type="text" wire:model="accion_lote" placeholder="Acciones en lote">
								<option value="Elegir">Acciones en lote</option>
								<option value="1">Eliminar</option>

								</select>
							<div class="input-group-append">
								<button style="background:white; border: solid 1px #bfc9d4;" wire:click="AccionEnLote()" type="button">Aplicar</button>
							</div>
						</div>

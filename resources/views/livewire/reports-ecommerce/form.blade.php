                                 ...
                                 <div class="invoice-container">
                                     <div class="invoice-inbox">
                                       ...
                                       <div style="{{$estado2}}" id="contenido-hr">
                                         ...
                                         <input type="text" wire:model="dateHojaRuta" class="form-control flatpickr" placeholder="Click para elegir">

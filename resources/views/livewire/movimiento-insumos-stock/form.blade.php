...
<div wire:ignore.self class="modal fade" id="theModal" tabindex="-1" role="dialog">
      ...
      margin: 1.75rem auto;" class="modal-dialog" role="document">
          ...
          <label for="">Cantidad</label>
           <input id="cantidad" onchange='calcular_agregar(this)' max="{{$stock}}" style="text-align: center; font-weight: bold;" min="1" type="number" class="form-control" wire:model.lazy="cantidad" >
           ...
           <input hidden id="precio_venta" style="text-align: center; font-weight: bold;" min="1" type="number" class="form-control" wire:model.lazy="price" >

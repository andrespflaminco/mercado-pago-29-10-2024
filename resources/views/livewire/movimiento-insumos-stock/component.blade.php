@inject('cart', 'App\Services\CartMovimientoInsumos')

	<div>
	
	              <div class="page-header">
					<div class="page-title">
							<h4>Nuevo movimiento de stock de insumos</h4>
							<h6>Agregue un nuevo movimiento de stock entre sucursales</h6>
						</div>
						<div class="page-btn  d-lg-flex d-sm-block">
						 
					        <a class="btn btn-added" href="{{ url('movimiento-insumos-stock-resumen') }}">Volver al resumen de movimientos</a>
						</div>
					</div>

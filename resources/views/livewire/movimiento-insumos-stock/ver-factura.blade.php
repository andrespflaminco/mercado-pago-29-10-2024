  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      @endif
              ...
              <button type="button" style="background:transparent; border-radius: 50%; margin-left:20px;" wire:click.prevent="CerrarFactura()">
                                     ...
                                     <div class="invoice-inbox">
                                       ...
                                       <div style="{{$estado2}}" id="contenido-hr">
                                         ...
                                         <a wire:click="SinAsignarHojaRuta({{$ventaId}} )" style="min-width:220px;" class="btn btn-light mb-2"> Sin asignar </a><br>
                                           <br><br><br>
                                            <a href="javascript:void(0)" style="color:blue;" wire:click="AbrirHRNueva({{$ventaId}} )" >Crear nueva Hoja de ruta</a>
                                       </div>
                                       </div>
                                       </div>
                                       </div>
                                       ...
                                       <div class="invoice-header-section">
                                         <div class="row">
                                           ...
                                           <div class="col-sm-12 col-md-12">
                                                     ...
                                                     <table class="multi-table table table-hover" style="width:100%">
                                                         ...
                                                         <tfoot>
                                                             <tr>
                                                                 ...
                                                                 <th class="text-center">$ {{number_format($suma_monto+$suma_cash+$rec,2)}}</th>
                                                             </tr>
                                                         </tfoot>
                                                     </table>
                                                 </div>
                                             ...
                                             @if(($suma_monto+$suma_cash) < ($tot+$rec - $desc))

                                             <strong>Deuda: $ {{($tot) - ($suma_monto+$suma_cash)}}</strong>
                                             <br><br>

                                              <div class="form-group">
                                                <a style="color:blue; cursor:pointer;" wire:click.prevent="AgregarPago({{$ventaId}})">
                                                    Agregar pago
                                                </a>
                                              </div>
                                                                       ...
                                                                       @foreach($detalle_venta as $item)
                                                                         <tr>
                                                                             ...
                                                                             <td class="text-right">
                                                                               ...
                                                                               @else
                                                                               $ {{number_format($item->price*(1+$item->iva),2)}}
                                                                             ...
                                                                             <td class="text-right">
                                                                               ...
                                                                               @else
                                                                               $ {{number_format($item->price*$item->quantity*(1+$item->iva),2)}}
                                                             ...
                                                             <div class="inv--total-amounts text-sm-right">
                                                               <div class="row">
                                                                   ...
                                                                   <div class="col-sm-4 col-5 grand-total-amount">
                                                                       <h4 class=""> $ {{$t->total + $t->iva + $t->recargo - $t->descuento}}</h4>
                                                                   </div>

						...
						@if(!empty($query))
								...
								<div style="position:absolute; z-index: 999 !important;"  class="absolute z-10 w-full bg-white rounded-t-none shadow-lg list-group">
										@if(!empty($contacts))
												...
												<a href="javascript:void(0)"   class="btn btn-light" wire:click="BuscarClienteAFIP" > 	<i class="fas fa-search"></i> Buscar CUIT en Afip</a>
...
<div class="col-lg-2 col-md-4 col-sm-12 d-none d-sm-block  ">
	<div style="margin-bottom: 0 !important;" class="input-group mb-4">
		...
		<div class="col-lg-2 col-md-4 col-sm-12 d-none d-sm-block">
			...
			<input autocomplete="off" type="date" wire:change="CambioCaja()" wire:model.lazy="fecha_pedido" class="form-control" >
    ...
    document.addEventListener('DOMContentLoaded', function(){
            livewire.on('scan-code', action => {
                $('#code').val('')
						...
						window.livewire.on('not-checked', Msg => {

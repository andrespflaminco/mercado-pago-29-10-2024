...
<div wire:ignore.self class="modal fade" id="theModal" tabindex="-1" role="dialog">
      ...
      margin: 1.75rem auto;" class="modal-dialog" role="document">
          ...
          <label for="">Cantidad</label>
           ...
           <input style="text-align: center; font-weight: bold;" min="1" type="number" class="form-control" value="{{$cost}}" wire:model="cost" >
           
           

           <input hidden id="stock" style="text-align: center; font-weight: bold;" min="1" type="number" class="form-control" wire:model="stock" >
           <input hidden type="text" id="selected_id" wire:model="selected_id" class="form-control" >
          <input hidden id="id_producto" type="text" wire:model="name" class="form-control" >

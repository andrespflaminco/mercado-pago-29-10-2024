  ...
  <div style="border: solid 1px #c8c8c8; padding:10px; border-radius:5px;">
    ...
    @endif
     ...
     <div class="modal-footer">
       ...
       <button type="button" wire:click.prevent="resetUIBanco()" class="btn btn-cancel" data-dismiss="modal">CERRAR</button>

       <button type="button" wire:click.prevent="StoreBanco()" class="btn btn-submit close-modal" >GUARDAR</button>

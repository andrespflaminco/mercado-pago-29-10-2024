      ...
      <div style="  max-width: 300px !important;
        margin: 1.75rem auto;" class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <button hidden wire:click.prevent="UpdateEstado('Pendiente de Retiro en Sucursal')" style="min-width: 200px; width:100%;"
                  class="btn btn-dark mb-2">
                  Pendiente de Retiro en Sucursal
              </button><br>
              
              <!-- Warning -->
              <button wire:click.prevent="UpdateEstado('Pendiente')" style="min-width: 200px; width:100%;"
                  class="btn btn-warning mb-2">
                  Pendiente
              </button><br>
              <button wire:click.prevent="UpdateEstado('En proceso')" style="min-width: 200px; width:100%;"
                  class="btn btn-secondary mb-2">
                  En proceso
              </button><br>
              <button wire:click.prevent="UpdateEstado('Entregado')" style="min-width: 200px;  width:100%;"

<div wire:ignore.self class="modal fade" id="ModalCliente" tabindex="-1" role="dialog" style="overflow-y: auto !important;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-dark">
        ...
        <button type="button" class="close" onclick="cerrarModalClientes()" >
...
<!----- GOOGLE MAPS ----->
     ...
     <div class="modal-footer">
       ...
       <button type="button" onclick="cerrarModalClientes" class="btn btn-dark close-btn text-info" data-dismiss="modal">CERRAR.</button>

       <button type="button" wire:click.prevent="StoreCliente()" class="btn btn-dark close-modal" >GUARDAR</button>

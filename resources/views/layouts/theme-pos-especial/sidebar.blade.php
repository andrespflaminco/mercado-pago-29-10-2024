						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li><a href="{{ url('movimiento-stock') }}">
									...
									</i><span>Movimientos de stock</span></a></li>
									@endcan
									...
									<li><a href="{{url('controlador-stock')}}"><i data-feather="list"></i><span>Control fisico stock</span></a></li>
									@endcan
									...
									@can('ver movimientos de stock')
									<li><a href="{{ url('historico-stock') }}"><i data-feather="align-justify"></i><span>Historico de stock</span></a></li>
									@endcan
							...
							<li class="submenu-open">
								...
								<ul>
									@can('ver facturacion')
									<li><a href="{{ url('facturacion') }}"><i data-feather="clipboard"></i><span>Facturacion</span></a></li>
									@endcan
								</ul>
							</li>
							@endif
